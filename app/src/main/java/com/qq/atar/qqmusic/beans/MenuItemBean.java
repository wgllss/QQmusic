 ...
 *
 */
package com.qq.atar.qqmusic.beans;
...
public class MenuItemBean implements Serializable {
     ...
     * @param menuItemName
     */
    public MenuItemBean(String itemId, String menuItemName, int iconID) {
    ...
    public MenuItemBean(String itemId, String menuItemName, String itemName2, String flag) {
        this.menuItemName = menuItemName;
        this.itemId = itemId;
